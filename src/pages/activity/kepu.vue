<template>
	<view :class="uiStyle=='normal'?'':'elder'">
		<u-form :model="form" ref="uForm" :border-bottom="true" label-width="184">
			...
			<uniSection title="科普信息" type="line">
				<u-form-item label="科普名称" required prop="activityname">
					<u-input v-model="form.activityname" placeholder="请输入科普名称" />
				</u-form-item>
				<u-form-item label="科普类别" required prop="category">
					...
					<!-- <view class="picker" @click="show5 = true">
						<view :class="category?'':'placeholder'">
							{{category?category:'请选择科普类别'}}
						</view>
						<view class="icon-arrow-right-s-line"></view>
					</view> -->
					<u-input v-model="category" placeholder="请选择科普类别" type="select"  @click="show5 = true" />
				...
				<u-form-item label="科普开始时间" required prop="starttime">
				...
				<u-form-item label="科普结束时间" required prop="endtime">
					...
					<!-- <view class="picker" @click="show4 = true">
						<view :class="form.endtime?'':'placeholder'">
							{{form.endtime?form.endtime:'请选择结束时间'}}
						</view>
						<view class="icon-arrow-right-s-line"></view>
					</view> -->
					<u-input v-model="form.endtime" placeholder="请选择结束时间" type="select"  @click="show4 = true" />
				</u-form-item>
				<u-form-item label="科普地点" required prop="schoolid">
				...
				<u-form-item label="科普人/单位" required prop="organization">
					<u-input v-model="form.organization" placeholder="请输入科普人/单位" />
				</u-form-item>
				<u-form-item label="科普介绍" required prop="introduce">
					<view style="width: 100%;">
						<u-input v-model="form.introduce" type="textarea" maxlength="160" placeholder="请输入科普介绍" />
	...
	export default {
		...
		data() {
			return {
				...
				picUped: true,
				activityid: null,
				type: 3, //0：志愿活动1：组队活动 2：宣讲活动 3：科普活动
			...
			getData() {
				this.http.post('activity/activityDetail', {
					...
					this.form = {
						...
						score: tmp.score, //0,2,3
						category: tmp.category, //2：宣讲活动 3：科普活动
						organization: tmp.organization, //2：宣讲活动 3：科普活动
					}
